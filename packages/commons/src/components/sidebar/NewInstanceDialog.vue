...
import { addTask, ProgressTask } from "../../utils/tasks";
...
<template>
  ...
  >
    ...
    >
      ...
      <ElTabs
        @tab-change="
          (name: any) => (form.installType = name as ServerInstallType)
        "
      >
        ...
        <ElTabPane :key="ServerInstallType.ImportPack" label="导入服务端整合包">
