...
const SOFT_DEFAULTS: Record<string, SoftDefault> = {
  ...
  "shared.nodes.status.connecting": {
    zh: "连接中",
    en: "Connecting",
    ja: "接続中",
    ru: "Связь.",
  ...
  "shared.create.field.name.label": {
    zh: "实例名称",
    en: "Instance Name",
    ja: "インスタンス名",
    ru: "Имя экземпляра",
  ...
  "shared.create.field.java.label": {
    zh: "Java 运行时",
    en: "Java Runtime",
    ja: "Java ランタイム",
    ru: "Среда выполнения Java",
  ...
  "shared.create.field.java.refresh": {
    zh: "自动搜索",
    en: "Auto search",
    ja: "自動検索",
  ...
  "shared.create.jvm-helper.min": {
    zh: "最小内存",
    en: "Minimum Memory",
    ja: "最小メモリ",
    ru: "Минимальный объем памяти",
  },
  "shared.create.jvm-helper.max": {
    zh: "最大内存",
    en: "Maximum memory",
    ja: "最大メモリ",
  ...
  "shared.create.status.request-failed": {
    zh: "请求失败 {status}: {url}",
    en: "Request failed {status}: {url}",
  },
  ...
  "shared.nodes.auto-refresh.label": {
    zh: "自动刷新",
    en: "Auto Refresh",
    ja: "自動更新",
    ru: "Автообновление",
  ...
  "shared.nodes.card.status": {
    zh: "链接状态",
    en: "Connection Status",
    ja: "リモートアドレス:",
    ru: "Удаленный адрес:",
  },
  "shared.nodes.card.system": {
    zh: "操作系统",
    en: "System",
    ja: "システム:",
    ru: "Система:",
  },
  "shared.nodes.card.daemon": {
    zh: "节点版本",
    en: "Node version",
    ja: "ノードバージョン:",
    ru: "Версия узла:",
  ...
  "shared.nodes.resource.cpu": { zh: "CPU", en: "CPU", ja: "CPU", ru: "CPU" },
  "shared.nodes.resource.memory": {
    zh: "内存",
    en: "Memory",
    ja: "メモリ",
    ru: "Память",
  ...
  "shared.nodes.connect.name.label": {
    zh: "备注名",
    en: "Comment Name",
    ja: "備考名",
    ru: "备注名",
  ...
  "shared.instance.events.new-desc": {
    zh: "新规则的描述",
    en: "Description of the new rule",
  },
  "shared.instance.events.load-failed": {
    zh: "加载事件规则失败",
    en: "Failed to load event rules",
  },
  "shared.instance.events.save-failed": {
    zh: "保存事件规则失败",
    en: "Failed to save event rules",
  },
  "shared.instance.events.import-failed": {
    zh: "导入失败",
    en: "Import failed",
  },
  "shared.instance.components.unsupported-title": {
    zh: "不支持组件管理",
    en: "Components unsupported",
  },
  ...
  "shared.instance.components.empty-title": {
    zh: "这里空空如也",
    en: "Nothing here",
  },
  "shared.instance.components.empty-mods": {
    zh: "还没有模组。",
    en: "No mods yet.",
  },
  "shared.instance.components.empty-plugins": {
    zh: "还没有插件。",
    en: "No plugins yet.",
  },
  ...
  "shared.instance.components.locate-copied": {
    zh: "路径已复制",
    en: "Path copied",
  },
  ...
  "shared.instance.files.editor-desc": {
    zh: "编辑守护进程上的文本文件，保存后写回。",
    en: "Edit a text file on the daemon and write it back on save.",
  },
  "shared.instance.files.editor-unsaved": {
    zh: "有未保存的更改，确定关闭？",
    en: "Discard unsaved changes and close?",
  },
  "shared.instance.files.editor-dirty": { zh: "未保存", en: "Unsaved changes" },
  "shared.instance.files.editor-clean": { zh: "已同步", en: "In sync" },
  "shared.instance.files.editor-large-warn": {
    zh: "文件较大，编辑可能较慢。",
    en: "Large file — editing may be slow.",
  },
  "shared.instance.files.editor-binary-confirm": {
    zh: "此文件可能不是纯文本，仍要打开编辑吗？",
    en: "This file may be binary. Open in editor anyway?",
  },
  "shared.instance.files.editor-load-failed": {
    zh: "加载文件失败",
    en: "Failed to load file",
  },
  "shared.instance.files.editor-save-failed": {
    zh: "保存文件失败",
  ...
  "shared.instance.files.editor-time-date": {
    zh: "时间/日期",
    en: "Time/Date",
  },
  ...
  "shared.instance.files.editor-zoom-reset": {
    zh: "还原默认缩放",
    en: "Restore default zoom",
  },
  ...
  "shared.instance.files.editor-line-numbers": {
    zh: "显示行号",
    en: "Show line numbers",
  },
  "shared.instance.files.editor-cursor": {
    zh: "行 {line}, 列 {col}",
    en: "Ln {line}, Col {col}",
  },
  "shared.instance.files.delete-multi": {
    zh: "{count} 个项目",
    en: "{count} items",
  },
  "shared.instance.files.download-multi-done": {
    zh: "已下载 {count} 个文件",
    en: "Downloaded {count} files",
  },
  ...
  "shared.instance.settings.java-scan-failed": {
    zh: "扫描 Java 失败",
    en: "Failed to scan Java runtimes",
  },
  "shared.instance.settings.java-count": {
    zh: "已找到 {count} 个 Java 运行时",
    en: "Found {count} Java runtime(s)",
  },
  "shared.instance.settings.java-empty": {
    zh: "未扫描到 Java，请点击扫描或手动填写路径",
    en: "No Java found. Scan again or enter a path manually.",
  },
  "shared.instance.settings.jvm-helper": { zh: "JVM 助手", en: "JVM helper" },
  "shared.instance.settings.core-replace": {
    zh: "替换核心",
    en: "Replace core",
  },
  "shared.instance.settings.core-pick": { zh: "选择 JAR", en: "Choose JAR" },
  "shared.instance.settings.core-none": {
    zh: "未选择新核心",
    en: "No replacement core selected",
  },
  "shared.instance.settings.core-replace-desc": {
    zh: "保存时会先上传到守护进程再替换实例核心。",
    en: "On save the JAR is uploaded then applied as the instance core.",
  },
  "shared.instance.settings.name-required": {
    zh: "实例名称不能为空",
    en: "Instance name is required",
  },
  ...
  "shared.instance.detail.files": {
    zh: "文件管理",
    en: "Files",
    ja: "ファイル管理",
    ru: "文件管理",
  },
  "shared.instance.detail.automation": {
    zh: "触发事件",
    en: "Events System",
    ja: "イベントトリガー",
    ru: "触发事件",
  },
  "shared.instance.detail.components": {
    zh: "组件管理",
    en: "Components",
    ja: "コンポーネント管理",
    ru: "组件管理",
  },
  "shared.instance.detail.settings": {
    zh: "实例设置",
  ...
  "shared.settings.download.source.label": {
    zh: "下载源",
    en: "Download source",
  },
  ...
  "web.api.error.login-failed": {
    zh: "用户名或密码不正确。",
    en: "Incorrect username or password.",
  },
  "web.api.error.admin-exists": {
    zh: "已存在管理员账户，请直接登录。",
    en: "An admin account already exists. Please sign in.",
  },
  "web.api.error.username-exists": {
    zh: "该用户名已被使用。",
    en: "This username is already taken.",
  },
  "web.api.error.user-not-found": {
    zh: "找不到该用户。",
    en: "User not found.",
  },
  "web.api.error.invalid-token": {
    zh: "登录已失效，请重新登录。",
    en: "Session expired. Please sign in again.",
  },
  "web.api.error.permission-denied": {
    zh: "没有权限执行此操作。",
    en: "You do not have permission for this action.",
  },
  "web.api.error.internal-server-error": {
    zh: "服务器繁忙，请稍后重试。",
    en: "Server is busy. Please try again later.",
  },
  "web.api.error.network-error": {
    zh: "无法连接服务器，请检查网络或确认面板服务已启动。",
    en: "Cannot reach the server. Check the network or panel service.",
  },
  "web.api.error.invalid-password": {
    zh: "密码不符合要求。",
    en: "Password does not meet requirements.",
  },
  "web.api.error.wrong-password": {
    zh: "原密码不正确。",
    en: "Current password is incorrect.",
  },
  "web.api.error.fallback": {
    zh: "操作失败，请稍后重试。",
    en: "Operation failed. Please try again later.",
  },
  "web.api.error.with-code": {
    zh: "操作失败（{code}）",
    en: "Operation failed ({code})",
  },
  "web.auth.login-failed": { zh: "登录失败", en: "Sign-in failed" },
  "web.auth.register-failed": { zh: "注册失败", en: "Registration failed" },
  "shared.create.validation.name.empty": {
    zh: "实例名称不能为空",
    en: "Instance name is required",
  },
  "shared.create.validation.name.dot": {
    zh: "实例名称不能为 . 或 ..",
    en: "Instance name cannot be . or ..",
  },
  "shared.create.validation.name.invalid": {
    zh: "实例名称包含非法字符",
    en: "Instance name contains invalid characters",
  },
  "shared.create.validation.java.empty": {
    zh: "请选择或填写 Java 路径",
    en: "Select or enter a Java path",
  },
  "shared.create.validation.java.display": {
    zh: "请选择具体的 Java 可执行文件路径",
    en: "Select a concrete Java executable path",
  },
  "shared.create.validation.jar.empty": {
    zh: "请选择服务器核心 jar 文件",
    en: "Select a server core jar file",
  },
  "shared.create.validation.jar.ext": {
    zh: "核心文件必须是 .jar",
    en: "Core file must be a .jar",
  },
  "shared.create.validation.loader": {
    zh: "请选择 Minecraft 版本与 Loader 版本",
    en: "Select Minecraft and loader versions",
  },
  "shared.daemon.error.disconnected": {
    zh: "无法连接到远程主机",
    en: "Failed to connect to daemon",
  },
  "shared.daemon.error.node-missing": {
    zh: "远程主机不存在",
    en: "Remote host not found",
  },
  "shared.daemon.error.token-missing": {
    zh: "缺少访问令牌",
    en: "Access token is missing",
  },
  "shared.daemon.error.system-info": {
    zh: "无法连接到远程主机",
    en: "Failed to connect to daemon",
  },
  "shared.daemon.error.connect-failed": {
    zh: "无法连接到远程主机",
    en: "Failed to connect to daemon",
    ja: "デーモンへの接続に失敗しました",
    ru: "Не удалось подключиться к демону",
  },
  "shared.daemon.error.refresh-failed": {
    zh: "刷新失败",
    en: "Refresh failed",
  },
  "shared.daemon.error.not-connected": {
    zh: "远程主机未连接",
    en: "Remote host is not connected",
  },
  "shared.daemon.error.operation-failed": {
    zh: "操作失败",
    en: "Operation failed",
  },
  "shared.daemon.error.ws-failed": {
    zh: "WebSocket 连接失败",
    en: "WebSocket connection failed",
  },
  "shared.daemon.error.ws-closed": {
    zh: "WebSocket 连接关闭",
    en: "WebSocket connection closed",
  },
  "shared.daemon.error.request-timeout": {
    zh: "请求超时：{action}",
    en: "Request timed out: {action}",
  },
  "shared.daemon.error.action-failed": {
    zh: "Action 失败：{action}",
    en: "Action failed: {action}",
  },
  "shared.daemon.error.create-no-config": {
    zh: "创建实例成功但未返回配置",
    en: "Instance created but no config returned",
  },
  "shared.daemon.error.upload-session": {
    zh: "文件上传会话创建失败",
    en: "Failed to create upload session",
  },
  "shared.daemon.error.upload-cancelled": {
    zh: "上传已取消",
    en: "Upload cancelled",
  },
  "shared.daemon.error.upload-chunk-timeout": {
    zh: "文件分片上传超时",
    en: "Upload chunk timed out",
  },
  "shared.daemon.error.read-logs-failed": {
    zh: "读取日志失败",
    en: "Failed to read logs",
  },
  ...
  "shared.resource-center.tag.proxy": {
    zh: "代理",
    en: "Proxy",
    ja: "ダウンロードキャンセル",
    ru: "下载已取消",
  },
  "shared.resource-center.tag.vanilla": {
    zh: "原版",
    en: "Vanilla",
    ja: "バニラ",
    ru: "Исходный текст",
  },
  "shared.resource-center.tag.pure": {
    zh: "纯净",
    en: "Purity",
    ja: "ピュア",
    ru: "чистый",
  },
  "shared.resource-center.tag.mod": {
    zh: "模组",
    en: "Mods",
    ja: "モッド",
    ru: "Модуль",
  },
  "shared.resource-center.tag.bedrock": {
    zh: "基岩",
    en: "Bedrock",
    ja: "統合版",
    ru: "коренная порода",
  },
  "shared.brand.platform.tauri": {
    zh: "Tauri (跨平台)",
    en: "Tauri (cross-platform)",
  },
