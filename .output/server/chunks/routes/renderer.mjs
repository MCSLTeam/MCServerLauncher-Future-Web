...
import { j as useRuntimeConfig, k as eventHandler, s as setResponseHeader, l as send, m as getResponseStatus, n as setResponseStatus, o as useNitroApp, p as setResponseHeaders, q as joinRelativeURL, t as getQuery, v as createError, x as getRouteRules, y as getResponseStatusText } from '../runtime.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[{"innerHTML":"<div class=\"noscript\"><p>MCSL Future Web 的部分功能需要启用 JavaScript 才可使用！</p></div>"}]};
